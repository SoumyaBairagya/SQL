...
void help(std::string query)
{
    ...
    if (tokens.size() == 1 && tokens[0] == "HELP")
    {
        ...
        std::cout << "\t"
                  << "-- HELP CREATE --> Help for CREATE command" << std::endl;
        std::cout << "\t"
                  << "-- HELP SELECT --> Help for SELECT command" << std::endl;
        std::cout << "\t"
                  << "-- HELP DESCRIBE --> Help for DESCRIBE command" << std::endl;
        std::cout << "\t"
                  << "-- HELP DROP --> Help for DROP command" << std::endl;
        std::cout << "\t"
                  << "-- HELP TRUNCATE --> Help for TRUNCATE command" << std::endl;
        std::cout << "\t"
                  << "-- HELP DELETE --> Help for DELETE command" << std::endl;
        std::cout << "\t"
                  << "-- HELP INSERT --> Help for INSERT command" << std::endl;
        std::cout << std::endl;
        return;
    }
    ...
    else if (tokens[1] == "CREATE;")
    {
        ...
        std::cout << "\t"
                  << "CREATE TABLE table_name (attr_name1 attr_type1, attr_name2 attr_type2, …);\n\n";
        return;
    }
